...
public class GuiManager {
    ...
    /**
     * Method to do an initialization of the {@link GuiManager} state. It SHOULD be called before calling the {@link GuiManager#newFrame()} method.
     * <p>
    ...
    private final class CreateWindowFunction extends ImPlatformFuncViewport {
        ...
        public void accept(final ImGuiViewport vp) {
            ...
            glfwSetMouseButtonCallback(data.window, GuiManager.this::mouseButtonCallback);
            glfwSetScrollCallback(data.window, GuiManager.this::scrollCallback);
            glfwSetKeyCallback(data.window, GuiManager.this::keyCallback);
            glfwSetCharCallback(data.window, GuiManager.this::charCallback);
            glfwSetWindowCloseCallback(data.window, GuiManager.this::windowCloseCallback);
            glfwSetWindowPosCallback(data.window, GuiManager.this::windowPosCallback);
            glfwSetWindowSizeCallback(data.window, GuiManager.this::windowSizeCallback);
