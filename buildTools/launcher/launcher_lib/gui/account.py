...
class Profile:
    def __init__(self, root, account: Account, login_function):
        ...
        self.frame = tk.Frame(root, width=180, height=60)
        self.account: Account = account

        self.frame.grid_columnconfigure(0, weight=0)
        self.frame.grid_columnconfigure(1, weight=0)

        self.login = tk.Button(self.frame, text='Login', height=1, width=15)
        ...
        self.user2.config(fg="#afafaf", font=("TkDefaultFont", 10))
        self.user2.grid_forget()

        self.manage = tk.Button(self.frame, text='+', height=1, width=2)
